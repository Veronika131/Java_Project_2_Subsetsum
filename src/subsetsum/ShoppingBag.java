...
public class ShoppingBag 
{
	...
	public ShoppingBag(String filePath)
	{
		...
		// TODO: Define the readFile() method which reads the CSV (Comma Separated Value) file
	 ...
	 */
	private ArrayList<Double> getPriceOfGroceries()
	{
	...
	public static void main(String[] args) 
	{
        ...
        //Three input files for testing
		final String FILEPATH = "resources/groceries.txt";
		//final String FILEPATH = "resources/groceries2.txt";
		//final String FILEPATH = "resources/groceries3.txt";
		...
		//looping until user enters numeric value
		do
		{
